...
class TestSolution(unittest.TestCase):
    ...
    def test_plot(self):
        with warnings.catch_warnings():
            ...
            ssim = skimage.metrics.structural_similarity(skimage.img_as_float(gold_image), 
    ...
    def test_plot_private(self):
        with warnings.catch_warnings():
            ...
            p = NDWellProductionPlot('eog', 'gas')
            p.save_plot()

            gold_image = cv2.imread('images/eog_gas_wells_in_nd_gold.png')
            test_image = cv2.imread('eog_wells_in_nd.png')
